            ...
            <button
              ...
              className={`p-1.5 rounded-lg transition-colors cursor-pointer ${
                project.favorite 
                  ...
                  : 'text-slate-400 dark:text-slate-500 hover:text-amber-500 hover:bg-slate-100 dark:hover:bg-slate-800 opacity-60 group-hover:opacity-100'
              }`}
              title={project.favorite ? 'Quitar de favoritos' : 'Marcar como favorito'}
            >
              <Star size={16} className={project.favorite ? 'fill-amber-500' : ''} />
            </button>
